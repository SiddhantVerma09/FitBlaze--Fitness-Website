...
function BMIFunction() {
    ...
    if (oz == "" || gm == "" || kg == "" || lbs == "") {
        ...
        if (bmiValue < 18.5) {
            comment.innerHTML = "You are underweight. Consult a nutritionist to gain muscle mass!";
        }
        else if (bmiValue > 24.9 && bmiValue < 30) {
            comment.innerHTML = "You are overweight. Consult a dietician to plan weight loss diet!";
        }
